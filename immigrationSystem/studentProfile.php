            ...
            <div class="container mb-6 ">
                <div class="row">
                    ...
                    <div class="container col-lg-6" style="padding:-3px; text-align:justify">
                        <b>You have to choose one of these options below to
                        be redirected into the page which contains the
                        procedure of your cycle for getting the student visa of canada.</b><br/><br/>
                        <div class="d-grid gap-2 col-6 mx-auto" style="margin-top:2px;">
                            <a role="button" class="btn btn-primary" href="bachelor.php" style="display:center;">Bachelor</a>
                            <a role="button" class="btn btn-secondary" href="master.php" style="display:center;">Master</a>
                            <a role="button" class="btn btn-info" href="phd.php" style="display:center;">PhD</a>
                        </div>
                    </div>
                </div>
            </div>
